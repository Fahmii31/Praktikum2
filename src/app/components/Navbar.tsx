const menuItems = [
    ...
    { label: "Blog", href: "/blog/1945/Indonesia-Raya" },
              ...
              <li key={label}>
                <a
                  ...
                  className={`block py-2 px-3 rounded-sm md:p-0
                    ${active 
                      ? "text-white bg-blue-700 md:bg-transparent md:text-blue-700 dark:bg-blue-600 md:dark:bg-transparent md:dark:text-blue-500" 
